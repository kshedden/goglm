...
__This repository is no longer being actively developed.  See (https://github.com/kshedden/statmodel/tree/master/glm) for the new version of this package.__
